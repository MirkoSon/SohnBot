...
async def increment_daily_search_count() -> tuple[int, bool] | None:
...
async def mark_alert_sent() -> bool:
...
async def claim_alert_slot(threshold: int) -> int | None:
    """
...
async def cleanup_old_volume_records(retention_days: int = 30) -> int:
